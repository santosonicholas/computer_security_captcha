	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action ="add_account_staff_response.php" method="POST" class="login100-form validate-form">
                    ...
                    <div>
					Roles<br>
                        <input type="radio" name="roles" value="su" required>Super User
                        <input type="radio" name="roles" value="adm" required>Administrator
						<br><br>
                    </div>

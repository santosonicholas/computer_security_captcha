		...
		<div class="container-fluid">
			<div class="row">
				<?php 
					...
					if(isset($_SESSION['delete_staff_success'])){
						$msg = $_SESSION['delete_staff_success'];
						echo "<span style='color:green'>$msg<span>";
						unset($_SESSION['delete_staff_success']);
					}
				?><br><br>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col-lg-12 text-center">
					<br>
					<button type="button" class="btn btn-primary"><a href="add_account_staff.php"><h5 style="color:white">Add a Staff Account</h5></a></button>
				</div>
			</div>
			<div class="row">
									...
									<table>
										<thead>
											<tr class="row-100 head">
												...
												<th class="cell100 column7">Roles</th>
										...
										<tbody>
											...
											while ($row = mysqli_fetch_array($result)){
												...
												<tr class='row100 body'>
													...
													<td class='cell100 column7'>$roles</td>
													<td class='cell100 column8'>
													<button><a href='edit_profile_list_staff.php?id=$id_account'><i class='zmdi zmdi-edit zmdi-hc-2x'></i></a></button>
													
													<button><a href='delete_account_staff.php?id=$id_account'><i class='zmdi zmdi-delete zmdi-hc-2x'></i></a></button>
													</td>
												</tr>
											";
											} ?>

		...
		<div class="container-login100">
			...
			if ($sess_roles=='su' || $sess_roles=='adm'){
				if (isset($_GET['id'])){
					...
					if ($id >1000){
						echo"
					<form action ='delete_account_member_response.php' method='POST' class='login100-form validate-form'>";							
								...
								echo"<span class='login100-form-title p-b-26'>
									Are you sure want to delete <br><h2 style='color:red'>$first_name $last_name </h2>
                                    ($roles) account with id $id?
                ...
                <div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
                            ...
                            <?php
                            echo" 
                            <form id='Cancel' action='list_account_details.php'>
                                <button name='form_submit' class='login100-form-btn'>
                                    Cancel
                                </button>
                   			</form>";?>
